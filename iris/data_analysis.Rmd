...
```{r fig2,fig.width=8,fig.height=6, message=FALSE, tidy=TRUE}
ggplot(iris, aes(Sepal.Length, Sepal.Width, colour=Species)) + geom_point()  + geom_smooth()  +  facet_grid(. ~ Species)
print("asdasdasdasd 
      asdasdasdasd
      asdasdasdasd
      asdasdasdasd
